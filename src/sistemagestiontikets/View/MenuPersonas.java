...
public class MenuPersonas {
    ...
    private void listarConductores() {
        ...
        if (lista.isEmpty()) { Consolautil.mostrarInfo("No hay conductores registrados."); return; }
        for (Conductor c : lista) { c.imprimirDetalle(); Consolautil.mostrarLinea(); }
    }
    ...
    private void listarPasajeros() {
        ...
        if (lista.isEmpty()) { Consolautil.mostrarInfo("No hay pasajeros registrados."); return; }
        for (Pasajero p : lista) { p.imprimirDetalle(); Consolautil.mostrarLinea(); }
    }
}
